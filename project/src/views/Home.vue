      ...
      <div class="container">
        <div class="subtitle">
          <p>
            ...
            <mark>edit mode</mark>, you can directly use it in the browser or
            import the JavaScript modules via the NPM package
          </p>
        </div>
        <CodeEditor
          @lang="getLanguage"
...
export default {
    ...
    data() {
        ...
        <div class="button_group">
          ...
          <button
            :class="{ selected: theme == 'github_dark' }"
            @click="changeTheme('github_dark')"
          >
            Github dark
          </button>
          <button
...
<script src="/path/code_editor.prod.js"></script>'
        ...
        ></CodeEditor>
        <p>
          Step 3. Declaring the component, and using the customized tag into the
          HTML template. For all configure items please check the
  ...
  components: {
      'code-editor': CodeEditor
        ...
        <CodeEditor
          ...
          width="100%"
        />
        <p>Step 2. Importing the component and registration.</p>
        <CodeEditor
          value="import CodeEditor from 'simple-code-editor';
export default {
    components: {
      CodeEditor
        ...
        <h3 style="margin-top: 60px">Customizing the theme style</h3>
        <p>You can cover the CSS file to customize the theme style.</p>
        <CodeEditor
...
<CodeEditor theme="" class="github_dark"></CodeEditor>'
        ...
        ></CodeEditor>
        <a
          href="https://github.com/justcaliturner/simple-code-editor"
          target="_blank"
          class="link"
        >
    ...
    <div class="api" id="api">
      <div class="container">
        ...
        <CodeEditor
          value='<CodeEditor :read_only="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <p>Default: unset</p>
        <p>
          Description: setting the contents of a code editor. If you want to
          bind the data, please use the property
          <a href="#v-model"><code>v-model</code></a>
        </p>
        <CodeEditor
          value='<CodeEditor value="console.log(13)"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        <p>UI Rendering:</p>
        <CodeEditor value="console.log(13)" width="100%"></CodeEditor>

        <h3 id="v-model">v-model</h3>
        <p>
          Description: varies based on the value of form inputs element or
          output of components, the specific usage you can read the
          <a
            target="_blank"
        ...
        <CodeEditor
          value='<CodeEditor v-model="demo"></CodeEditor>
<CodeEditor v-model="demo"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <h3 id="language_selector">
          language_selector<label> - Boolean</label>
        </h3>
        <p>Default: <code>false</code></p>
        <p>
        ...
        <CodeEditor
          value='<CodeEditor :language_selector="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        <p>UI Rendering:</p>
        <CodeEditor
          value="// You can select the language in the top left corner"
          :language_selector="true"
          width="100%"
        ></CodeEditor>
        ...
        <p>
          Default:
          <code
            >[["javascript", "JS"],["cpp", "C++"],["python", "Python"]]</code
          >
        </p>
        <p>
          Description: This property is a two-dimensional array, the first item
          of each child is an index of the language and it's required, the
          second item of each child is used for display, which is for the better
          user reading experience, it can be free to customize and optional, if
          it's unset, the UI display will be replaced with the index of the
          language. When the value of
    ...
    "zephir"
        ...
        <h3>wrap_code<label> - Boolean</label></h3>
        <p>Default: <code>false</code></p>
        <p>Description: whether the code is allowed to wrap automatically</p>
        <CodeEditor
          value='<CodeEditor :wrap_code="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          :languages="[['html', 'HTML']]"
          :wrap_code="true"
          value=' <!-- The code can wrap automatically -->
<CodeEditor :language_selector="true" :hide_header="true"></CodeEditor>'
          width="100%"
        ></CodeEditor>

        <h3>hide_header<label> - Boolean</label></h3>
        <p>Default: <code>false</code></p>
        <p>Description: whether the header of code editor is hidden</p>
        <CodeEditor
          value='<CodeEditor :hide_header="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          value='<CodeEditor :display_language="false"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        <p>UI Rendering:</p>
        <CodeEditor
          value="// The language name is hidden"
        ...
        <CodeEditor
          value='<CodeEditor :copy_code="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        <p>UI Rendering:</p>
        <CodeEditor
          value="// The icon button is hidden"
          :copy_code="false"
          width="100%"
        ></CodeEditor>
        ...
        <p>Description: switching between light and dark themes</p>
        <CodeEditor
        ...
        <CodeEditor
          value='<CodeEditor font_size="17px"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          value='<CodeEditor width="540px"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <p>
          Description: the height of the container is adaptive by default, you
          can also set it to a specific value, and the scroll bar will work with
          a long text
        </p>
        <CodeEditor
          value='<CodeEditor height="150px"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        <p>UI Rendering:</p>
        <CodeEditor
          value="// The scroll bar will work with a long text"
          height="150px"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          value='<CodeEditor border_radius="4px"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          :hide_header="false"
          value="// The border radius is 4px"
          border_radius="4px"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          value='<CodeEditor selector_width="150px"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          :languages="[
            ['javascript', 'JS'],
            ['css', 'The width is 150px'],
          ]"
          :language_selector="true"
          :selector_displayed_by_default="true"
          value="// Demo"
        ...
        <CodeEditor
          value='<CodeEditor selector_height="90px"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <CodeEditor
          value='<CodeEditor :selector_displayed_by_default="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
        ...
        <p>Default: <code>false</code></p>
        <p>
          Description: whether the code editor should automatically get focus
          when the page loads
        </p>
        <CodeEditor
          value='<CodeEditor :autofocus="true"></CodeEditor>'
          :languages="[['html', 'HTML']]"
          :read_only="true"
          width="100%"
        ></CodeEditor>
